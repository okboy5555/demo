    ...
    <article>
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <form action="newsCheck.php" method="post">
                    <div class="form-group">
                        <label for="exampleInputTitle">新闻标题</label>
                        <input class="form-control" id="exampleInputTitle" name="newsTitle" placeholder="newsTitle">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="newsRemark" name="newsRemark">
                            ...
                            while($rows=mysql_fetch_array($result)){
                                array_push($query,$rows['newsRemark']);
                            }
                            $query=array_unique($query);
                            ?>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="newsContent" cols="100" rows="10" name="newsContent"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="newsImg">图片地址</label>
                        <input class="form-control" id="newsImg" placeholder="newsImg" name="newsImg">
                    </div>
